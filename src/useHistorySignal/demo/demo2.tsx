/**
 * title: Manual Commit
 * desc:  Manually track the change history of a Signal
 *
 * title.zh-CN: 手动提交
 * desc.zh-CN: 手动追踪信号的变化历史
 */
...
export default () => {
  ...
  const { undo, redo, history, canRedo, canUndo, commit } = useHistorySignal(
    count,
    {
  ...
  return (
    <div>
      ...
      <button type="button" onClick={commit} style={{ 'margin-right': '16px' }}>
        commit
      </button>
      <button
        type="button"
